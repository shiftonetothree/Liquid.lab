function TestSnowBall() {
  ...
  // 重力
  world.SetGravity(new b2Vec2(0, -0.01));
  
}

TestSnowBall.prototype.Step = function() {
  if(Math.floor(this.time * 60) % 6 === 0){
    var box = new b2PolygonShape();
    box.SetAsBoxXYCenterAngle(0.06, 0.03, new b2Vec2(0 + (Math.random() - 0.5) * 3, 1.5), Math.random() * Math.PI);
